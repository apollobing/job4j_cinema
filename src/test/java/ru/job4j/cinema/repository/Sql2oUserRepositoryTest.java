...
class Sql2oUserRepositoryTest {
    ...
    public void whenSaveSeveralThenGetAll() {
        var user1 = sql2oUserRepository.save(new User(0, "Mia", "mia@email.com", "plm"));
        var savedUser1 = sql2oUserRepository.findByEmailAndPassword(user1.orElseThrow().getEmail(), user1.orElseThrow().getPassword());
        var user2 = sql2oUserRepository.save(new User(0, "Ben", "ben@email.com", "okm"));
    ...
    public void whenSaveExistingUserThenNothingSave() {
        var user1 = sql2oUserRepository.save(new User(0, "Bob", "bob@email.com", "wsx"));
        var user2 = sql2oUserRepository.save(new User(0, "Tim", "bob@email.com", "xsw"));
